...
Load customer features (CDNA.csv) and email history (HISTORY.csv).

Aggregate email history and create multi-output targets.

Merge customer demographics with engagement targets.

Perform Train-Test Split (80-20) with random_state=42.

Train MultiOutputClassifier on training data.

Evaluate precision score for each of 28 time slots.
